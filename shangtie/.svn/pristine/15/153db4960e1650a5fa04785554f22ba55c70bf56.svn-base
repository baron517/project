 ...
 */
var serveUrl="http://st.diguikeji.com/";
...
$(function()
{
    ...
    $("#footer .aui-bar-tab-item").click(function()
    {
...
function openPicView(imgUrl)
{

    localStorage.picViewImgUrl=imgUrl;
