		...
		var f = {
			...
			onTabRollLeft: function () {
				h.on("click", ".roll-nav-left", function () {
					...
					var k = parseFloat(j) + b.getMarginStep() + 0;
					i.css("margin-left", k > 0 ? 0 : k)
				});
				return f
			},
